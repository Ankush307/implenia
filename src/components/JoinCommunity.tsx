  ...
  return (
    <div className="bg-gray pt-[129px] pb-[130px] max-lg:py-28 max-md:py-20 max-sm:py-16 px-5">
      <div className="container max-w-[1108px] flex flex-col justify-center relative mx-auto">
        <CustomHeading myClass="pb-[144px] max-lg:pb-[100px] max-md:pb-[70px] max-sm:pb-[0px] max-sm:text-center" text="WHAT OUR COMMUNITY SAYS" />
        <div>
          <Swiper className="mySwiper" modules={[Navigation, Pagination]} loop={true}
            ...
            {COMMUNITY_LIST.map((item, index) => (
              <SwiperSlide key={index}>
                <div className="max-w-[795px] flex flex-col justify-center mx-auto mb-12">
                  <p className="text-[100px] text-center leading-[125px] max-md:leading-[100%] mb-[-50px] text-orangeLight tracking-[-0.66px]">“ </p>
                  ...
                  <div className="flex items-center gap-3.5 max-w-[710px] max-lg:max-w-[unset] max-lg:justify-center mt-[30px] max-md:mt-5 max-sm:mt-[15px] ml-auto w-full">
                    ...
                    <div>
                      <p className="text-lightGray text-[21px] font-semibold max-lg:text-xl max-md:text-lg max-sm:text-base">{item.post}</p>
        ...
        <CustomButton myClass="text-light-red border-light-red py-4 px-8 max-w-[268px] min-w-[268px] !mx-auto font-bold font-sans-bold hover:bg-light-red hover:text-white mt-[39px] ml-5 max-lg:text-center max-lg:ml-0 max-lg:mt-6" text="More Stories"/>
      </div>
    </div>
  );
};
